  ...
  return (
    <div>
      <PageHeader
        ...
        description="Verify, suspend, or onboard guides across all languages."
      />
      <DataTable
        rows={data}
        loading={isLoading}
        columns={[
          {
            ...
            render: (g: any) => (
              <div className="flex items-center gap-3">
                <div className="size-9 rounded-full bg-elevated grid place-items-center">
